...
///Flutter applications can be imported through flutter bloc. import 'package:flutter_bloc/flutter_bloc.dart';
///AngularDart applications can be imported using angular_bloc. import 'package: angular_bloc/angular_bloc.dart';
///
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     icon: Icon(Icons.chevron_left, color: Colors.black,) ), 
      ...
      fontSize: 16 , fontWeight: FontWeight.w700),),backgroundColor: Colors.white,
    ),
    body: Center(
      child: ListView( 
          children: [
